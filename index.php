    ...
    <div class="container">
        ...
        <div class="wrapper">
            <div class="slider-container">
                <div class="slider-track">
                    ...
                    <div class="slider__item">
                        <img src="img/Mercury_in_color_-_Prockter07_centered 1 (1).png" alt="">
                        <h1>Меркурий</h1>
                        <p>Ближайшая к солнцу планета в солнечной системы наименьшая из планет земной группы</p>
                        <a href="">Подробнее</a>
                    </div>
                    <div class="slider__item">
                        <img src="img/Venera-e1543347318996 1 (1).png" alt="">
                        <h1>Венера</h1>
                    ...
                    <div class="slider__item">
                        <img src="img/юпи.png" alt="">
                        <h1>Юпитер</h1>
                        <p>Пятая планета от Солнца и самая большая в Солнечной системе.</p>
                        <a href="">Подробнее</a>
                    </div>
                    <div class="slider__item">
                        <img src="img/Saturn_-_April_25_2016_(37612580000) 1.png" alt="">
                        <h1>Сатурн</h1>
            ...
            <div class="slider-buttons">
                <button class="btn"><img src="img/Vector 11.svg" alt=""></button>
                <button class="btn"><img src="img/Vector 12.png" alt=""></button>
            </div>
    ...
    <nav>
        <div class="earch">
            ...
            <div class="earchimg">
                ...
                <p>Земля́ — третья по удалённости от Солнца планета Солнечной системы. Самая плотная, пятая по диаметру и массе среди всех планет и крупнейшая среди планет земной группы, в которую входят также Меркурий, Венера и Марс. Единственное известное
        ...
        <div class="how">
            ...
            <p>Современной научной гипотезой формирования Земли и других планет Солнечной системы является гипотеза солнечной туманности, по которой Солнечная система образовалась из большого облака межзвёздной пыли и газа. Облако состояло главным образом
        ...
        <div class="stroenie">
            ...
            <p><span>Cтроение Земли<br></span> Земля относится к планетам земной группы, и в отличие от газовых гигантов, таких как Юпитер, имеет твёрдую поверхность. Это крупнейшая из четырёх планет земной группы в Солнечной системе, как по размеру, так
                и по массе. Кроме того, Земля среди этих четырёх планет имеет наибольшие плотность, поверхностную гравитацию и магнитное поле[83]. Это единственная известная планета с активной тектоникой плит.</p>
