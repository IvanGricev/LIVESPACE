...
я
	...
	booleans = "проверено | выбрано | асинхронно | автофокус | автозапуск | элементы управления | отложить | отключено | отключено | скрыто | ismap | цикл | множественный | открытый | только для чтения | требуется | требуется»,
